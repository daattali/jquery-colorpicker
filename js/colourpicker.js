...
(function (factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    // colsToNames is a giant list of R color names in hex8 format (surely there is a better way to handle the grays, but this is okay for now)
    ...
    //flipped version of colsToNames, uses 'gray' instead of 'grey' and removes duplicates
